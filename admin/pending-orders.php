...
// $to=date('Y-m-d')." ".$t1;
$status='Delivered';
$sql ="SELECT * FROM orders JOIN users JOIN products ON orders.userId=users.id AND orders.productid=products.product_id WHERE  orderStatus!='$status' || orderStatus is null";
