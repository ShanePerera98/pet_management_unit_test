...
if(isset($_POST['add_dog'])){
    ...
    $pro=$pros[0];
    if($pro['d_name']==$d_name AND $pro['gender']==$gender AND $pro['user_id']==$userid){
...
//INSERT INTO `dogs`(`d_id`, `d_name`, `category`, `gender`, `age`, `d_image`, `price`, `quantity`, `petid`, `user_id`, `date_added`)
    ...
    $sql ="INSERT INTO `dogs`(`name`, `category`, `gender`,`age`,`dob`, `image`, `price`, `quantity`,`petid`,`user_id`,`date_added`)
