...
if(isset($_POST['update'])){
    ...
    $sql="UPDATE dogs SET price=:pric,quantity=:quant WHERE product_id=:productid ";
    ...
    try{
		...
		echo $e->getMessage();
		echo '<script>alert("Update  Contact The Admin at admin@dgw.com.ng");
		location.href="manage_products.php";</script>';

		}
}
$productid=$_GET['productid'];
$sql="SELECT * FROM `dogs` JOIN category  ON dogs.category=category.id  WHERE product_id=$productid";
$stmt = $pdo->prepare($sql);
$stmt->execute();
