...
$t1="23:59:59";
$to=date('Y-m-d')." ".$t1;
$sql ="SELECT * FROM orders JOIN users JOIN dogs ON orders.userId=users.id and orders.productid=dogs.product_id WHERE orderDate BETWEEN '$from' AND '$to' and OrderStatus is Null";
